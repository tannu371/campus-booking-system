      ...
      <div className="auth-card glass-strong">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input id="register-email" type="email" className="form-input" placeholder="your@campus.edu" value={email} onChange={e => setEmail(e.target.value)} required />
          </div>
          <div className="form-group">
            <label className="form-label">Department</label>
            <input id="register-department" type="text" className="form-input" placeholder="e.g. Computer Science" value={department} onChange={e => setDepartment(e.target.value)} />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input id="register-confirm-password" type="password" className="form-input" placeholder="Repeat password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required />
          </div>
